...
function App() {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios.post('https://cricktic.in//manual_news/get_post_social/', formData)
      .then((response) => {
  ...
  const HandleSubscriber = () => {
    ...
    axios.get('https://cricktic.in//subscription/get_post_social/')
      .then(response => {
        //  //// console.log(response)
  ...
  const HandleSubscriberDelete = (id) => {
    ...
    axios.delete(`https://cricktic.in//subscription/get_put_patch_delete_socialByID/${id}`)
      .then(response => {
        if (response.data == "") {
  ...
  const handlePostCode = (e) => {
    ...
    axios.post("https://cricktic.in//manual_news/get_post_twitter/", newInputData)
      .then(function (response) {
  ...
  const handleGetTwiter = () => {
    axios.get('https://cricktic.in//manual_news/get_post_twitter/')
      .then(function (response) {
        // Handle success
        console.log(response)
        const newsData = (response.data)
  ...
  const handlePostDelete = async (id) => {
    //// console.log(id)
    try {
      await axios.delete(`https://cricktic.in//manual_news/get_put_patch_delete_twitterByID/${id}`);
  ...
  const handleContactus = () => {
    axios.get(`https://cricktic.in//contact/get_post_social/`)
      .then(response => {
        // console.log(response)
  ...
  const handlecontactusDelete = (id) => {
    axios.delete(`https://cricktic.in//contact/get_put_patch_delete_socialByID/${id}`)
      .then(response => {
        if (response.data == "") {
