    ...
    <>
      <nav class="navbar navbar-expand-lg navbar-light sticky-top  header1">
        <div class="container-fluid" id='container-fluid'>
          <Link class="navbar-brand" to="/"><img src="./purplebg1.png" classupload_video="App-logo" alt="logo" className="logo" /></Link>
      ...
      <header className="container-fluid Navbar active d-flex justify-content-start header2   " >
        <nav ref={navRef} className="nav " >
          ...
          <Dropdown>
            <Dropdown.Toggle variant="light" id="teamRankingDropdown h1" style={{ backgroundColor: "transparent", border:'none' }}  >
            <i className="fa-solid fa-arrow-up-right-dots mx-1 text-success"></i> Team Ranking
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item as={Link} to="/teamRanking">
                <i className="fa-solid fa-people-group"></i> Women Team Ranking
              </Dropdown.Item>
              <Dropdown.Item as={Link} to="/menteamrank">
                <i className="fa-solid fa-people-group"></i> Men Team Ranking
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          ...
          {isMobile && (
            <button className="my-5 nav-btn" onClick={showNavbar}>
              <FaBars />
            </button>
          )}
        </nav>
