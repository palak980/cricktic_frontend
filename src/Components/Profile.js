...
function ProfileView() {
  ...
  const fetchProfile = () => {
    axios.get(`https://cricktic.in/profile/putProfileview/${profileId}/`)
      .then(response => {
  ...
  const updateProfile = () => {
    ...
    axios.put(`https://cricktic.in/profile/putProfileview/${profileId}/`, updatedProfile)
      .then(response => {
        console.log(response);
      })
      .catch(error => {
  ...
  const deleteProfile = () => {
    axios.delete(`https://cricktic.in/profile/putProfileview/${profileId}/`)
      .then(response => {
        console.log(response);
      })
      .catch(error => {
  ...
  const handleSubmit = event => {
    ...
    axios.post('https://cricktic.in/profile/Profileview/', formData)
      .then(response => {
        console.log(response);
      })
      .catch(error => {
  ...
  useEffect(() => {
    axios.get('https://cricktic.in/profile/GetProfileview/')
      .then(response => {
