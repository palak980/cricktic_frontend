...
function ProfileView() {
  ...
  const fetchProfile = () => {
    axios.get(`https://liveupcomingpro-production.up.railway.app/profile/putProfileview/${profileId}/`)
      .then(response => {
  ...
  const updateProfile = () => {
    ...
    axios.put(`https://liveupcomingpro-production.up.railway.app/profile/putProfileview/${profileId}/`, updatedProfile)
      .then(response => {
        //console.log(response);
      })
      .catch(error => {
  ...
  const deleteProfile = () => {
    axios.delete(`https://liveupcomingpro-production.up.railway.app/profile/putProfileview/${profileId}/`)
      .then(response => {
        //console.log(response);
      })
      .catch(error => {
  ...
  const handleSubmit = event => {
    ...
    axios.post('https://liveupcomingpro-production.up.railway.app/profile/Profileview/', formData)
      .then(response => {
        //console.log(response);
      })
      .catch(error => {
  ...
  useEffect(() => {
    axios.get('https://liveupcomingpro-production.up.railway.app/profile/GetProfileview/')
      .then(response => {
